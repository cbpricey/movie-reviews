    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIReviewModel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AIReviewModel_Actors_ActorId",
                        column: x => x.ActorId,
                        principalTable: "Actors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AIReviewModel_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIReviewModel_ActorId",
                table: "AIReviewModel",
                column: "ActorId");

            migrationBuilder.CreateIndex(
                name: "IX_AIReviewModel_MovieId",
                table: "AIReviewModel",
                column: "MovieId");
        }
